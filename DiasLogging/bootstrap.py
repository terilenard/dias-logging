...
def bootstrap_tpm(key_type, bits, path):
    pass
...
if __name__ == "__main__":
    ...
    parser.add_argument("--do_tpm", type=bool, default=False, help="If set to True, will bootstrap the credentials using TSS2 TPM, otherwise OpenSSL.")
    ...
    if args.do_tpm:
        bootstrap_tpm(args.key_type, args.bits, args.path)
    else:
